...
public class TaskScheduleImplementation {

	private static final Logger LOGGER= LogManager.getLogger(TaskScheduleImplementation.class);
	...
	public LocalDateTime startTimeInput() {
		...
		while (flag) {
			try {
				...
				startTime = new Validations().startDateValid(scan.nextLine());
				flag = false;
			} catch (Exception e) {
