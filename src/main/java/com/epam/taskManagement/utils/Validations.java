...
public class Validations {
	...
	// Overload
	public LocalDateTime startDateValid(String startDate, LocalDateTime endDate)
			throws DateTimeFormatException, DateTimeInputException {
		try {
	...
	public LocalDateTime endDateValid(LocalDateTime startDate, String endDate)
			throws DateTimeFormatException, DateTimeInputException {
		try {
